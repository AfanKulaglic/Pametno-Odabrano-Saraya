...
import CategoryGrid from "../../app/EditorPicks/components/Category"; // prilagodi path ako je drugačiji
import { Item } from "../../app/lib/types";

// ✅ Mock proizvodi iz iste kategorije — "Pametni uređaji"
const mockCategoryItems: Item[] = [
  {
      "id": "item_502",
      "type": "product",
...
// 🔹 Default — prikazuje sve iteme u kategoriji
...
// 🔹 Samo jedan item (test male grupe)
export const SingleItem: Story = {
  args: {
    category: "Pametni uređaji",
    categoryItems: [mockCategoryItems[0]],
    collectionId: "collection_001",
    loading: false,
  },
};

// 🔹 Loading state — skeleton prikaz
